		...
		<div class="row align-items-center my-5">
			...
			<div class="col-lg-7">
				<img class="img-fluid rounded mb-4 mb-lg-0"
					src="/nongbu/resources/images/food9.jpg" alt="">
			</div>
			...
			<div class="col-lg-5"
				...
				<h4 class="font-weight-light">
					<b>[농부의 텃밭] 국내산 고당도 딸기 산지직송</b>
				</h4>
				<br> <br>
				<h6 class="font-weight-light">가격 : 22,900원(1kg)</h6>
				<br>
				<h6 class="font-weight-light">원산지 : 경북 경산시</h6>
				<br>
				<h6 class="font-weight-light">친환경 인증 : 유기농</h6>
				<br>
				<h6 class="font-weight-light">생산시기 : 12월상순, 12월중순, 12월하순, 1월상순,
					1월중순, 1월하순</h6>
				<br>
