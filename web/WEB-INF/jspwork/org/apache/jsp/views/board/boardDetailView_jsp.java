 ...
 * Generated at: 2021-01-07 14:11:42 UTC
...
public final class boardDetailView_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(board.getBoardOriginalFileName() == null){ //첨부파일이 없다면 
      ...
      out.write("\r\n");
      out.write("<a href=\"/nongbu/bfdown?ofile=");
 ...
 if(board.getBoardReplyLev() < 3) { 
      out.write("\r\n");
      out.write("\t<a href=\"/nongbu/views/board/boardReplyForm.jsp?bnum=");
      out.print( board.getBoardNum() );
      out.write("&page=");
 ...
 if(loginMember.getUserId().equals(board.getBoardWriter()) == true){ //회원 자신의 글일때만 수정/삭제할 수 있게 함 
      out.write("\r\n");
      out.write("\t<a href=\"/nongbu/bupview?bnum=");
      out.print( board.getBoardNum() );
      out.write("&page=");
      out.print( currentPage );
      out.write("\">[수정페이지로 이동]</a> &nbsp; &nbsp; \r\n");
      out.write("\t<a href=\"/nongbu/bdelete?bnum=");
      out.print( board.getBoardNum() );
      out.write("&level=");
      out.print( board.getBoardReplyLev() );
      out.write("&rfile=");
      out.print( board.getBoardRenameFileName() );
      out.write("\">[글삭제]</a> &nbsp; &nbsp; \r\n");
 }} 
