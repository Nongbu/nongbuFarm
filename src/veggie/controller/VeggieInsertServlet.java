 ...
 */
@WebServlet("/proInsert")
public class VeggieInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public VeggieInsertServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		pro.setProID(loginMember.getUserId());
		
		// 6. 모델의 서비스 객체 생성하고, 메소드 실행하고 결과받기
		int result = new ProductService().insertPro(pro);
